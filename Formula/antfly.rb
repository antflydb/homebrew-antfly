class Antfly < Formula
  desc "AntflyDB indexing service"
  homepage "https://antfly.io"
  version "0.1.0"
  license "Apache-2.0"

  on_macos do
    url "https://github.com/antflydb/antfly/releases/download/v#{version}/antfly_#{version}_Darwin_all.tar.gz"
    sha256 ""
  ...
  def install
    ...
    generate_completions_from_executable(bin/"antfly", "completion")
  end
